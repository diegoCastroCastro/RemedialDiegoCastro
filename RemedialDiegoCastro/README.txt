...
a persistence unit "RemedialDiegoCastroPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RemedialDiegoCastro\pom.xml":
...
artifact ("RemedialDiegoCastro.war") is already built. You can build
